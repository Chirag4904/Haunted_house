...
const busMaterial = new THREE.MeshStandardMaterial({color:0x00ff00})
...
const bush4 = new THREE.Mesh(bushGeometry,busMaterial)
...
for (let i=0;i<50;i++){
    ...
    const radius = 3.3+Math.random()*6.3
...
const tick = () =>
{
    ...
    ghost3.position.x = Math.sin(ghostAngle3)*(7+Math.sin(elapsedTime*0.35))
    ghost3.position.z = Math.cos(ghostAngle3)*(7+Math.sin(elapsedTime*0.2))
